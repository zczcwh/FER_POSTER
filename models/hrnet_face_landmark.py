...
# hrnet_config = {"MODEL":{"INIT_WEIGHTS":True, "PRETRAINED":"HR18-AFLW.pth", "NUM_JOINTS":19, "TARGET_TYPE":'Gaussian',
#          "IMAGE_SIZE": [256, 256] , "HEATMAP_SIZE": [64, 64], "SIGMA":1.5,
#          "EXTRA":{"PRETRAINED_LAYERS":['*'], "STEM_INPLANES":64,"FINAL_CONV_KERNEL":1, "WITH_HEAD":True,
#                   "STAGE2":{"NUM_MODULES":1, "NUM_BRANCHES":2, "NUM_BLOCKS":[4, 4], "NUM_CHANNELS":[18, 36],
#                             "BLOCK": 'BASIC', "FUSE_METHOD":'SUM' },
#                   "STAGE3":{"NUM_MODULES":4, "NUM_BRANCHES":3, "NUM_BLOCKS":[4, 4, 4],
#                              "NUM_CHANNELS":[18, 36, 72], "BLOCK": 'BASIC', "FUSE_METHOD":'SUM' },
#                   "STAGE4":{"NUM_MODULES":3, "NUM_BRANCHES":4, "NUM_BLOCKS":[4, 4, 4, 4],
#                              "NUM_CHANNELS":[18, 36, 72, 144], "BLOCK": 'BASIC', "FUSE_METHOD":'SUM' },
#                   }}}
...
# from hrnet_config import config as hrnet_config
# model = get_face_alignment_net(hrnet_config)
#
#
#
